...
public class CustomScrollRect : ScrollRect
{
    ...
    bool forParent;
    NestedScrollController NM;
    ScrollRect parentScrollRect;

    protected override void Start()
    {
        NM = GameObject.FindWithTag(NestedScrollTag).GetComponent<NestedScrollController>();
        parentScrollRect = GameObject.FindWithTag(NestedScrollTag).GetComponent<ScrollRect>();
    }
