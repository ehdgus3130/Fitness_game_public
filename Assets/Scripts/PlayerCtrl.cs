...
public class PlayerCtrl : Singleton<PlayerCtrl>
{
    ...
    void Start()
    {
        ...
        //transform.position = QueueRoutin.Instance.Screen.position;//this.transform.parent.position;
    ...
    void FixedUpdate()
    {
        bool hasInput = QueueRoutin.Instance.CheckInput();
        bool isDay = LevelControl.Instance.TimeDay;
        if (!hasInput || !isDay)
        {
